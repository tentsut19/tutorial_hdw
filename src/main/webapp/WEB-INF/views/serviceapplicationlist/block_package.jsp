...
<div class="row mt15">
									<div class="col-md-12">
										<fieldset>
											...
											<div class="row">
												<div class="col-md-4">
													<label for="exampleSelect1"><b>ประเภทบริการ</b></label> 
																		...
																		<td scope="row">
																			...
																			<div class="input-group">
																				<input type="text" class="form-control" style="text-align: center;"
																					value="${serviceApplicationBean.installationFee}" id="installationFee_ismonthlyservice">
																				<div class="input-group-addon">บาท</div>
																			</div></td>
																		<td scope="row"><div class="input-group">
																				<input type="text" class="form-control" style="text-align: center;"
																					value="${serviceApplicationBean.deposit}" id="deposit_ismonthlyservice">
																				<div class="input-group-addon">บาท</div>
																			</div></td>
<!-- 																		<td scope="row"><div class="input-group"> -->
<%-- 																				<input type="text" class="form-control" style="text-align: center;" value="${serviceApplicationBean.firstBillFree}" --%>
<!-- 																					id="firstBillFree_ismonthlyservice"> -->
<!-- 																				<div class="input-group-addon">เดือน</div> -->
<!-- 																			</div></td> -->
																		<td scope="row"><div class="input-group">
																				<input type="text" class="form-control" style="text-align: center;"
																					value="${serviceApplicationBean.firstBillFreeDisCount}" id="firstBillFreeDisCount_ismonthlyservice">
																				<div class="input-group-addon">บาท</div>
																			</div></td>
																		<td scope="row"><div class="input-group">
																				<input type="text" class="form-control" style="text-align: center;"
																					value="${serviceApplicationBean.monthlyServiceFee}" id="monthlyServiceFee_ismonthlyservice">
																				<div class="input-group-addon">บาท</div>
																			</div></td>
																	</tr>
																</tbody>
																	...
																	<tr>
																		<td scope="row"><div class="input-group">
																				<input type="text" class="form-control"
																					value="${serviceApplicationBean.installationFee}" id="installationFee">
																				<div class="input-group-addon">บาท</div>
																			</div></td>
																		<td scope="row"><div class="input-group">
																				<input type="text" class="form-control"
																					value="${serviceApplicationBean.deposit}" id="deposit">
																				<div class="input-group-addon">บาท</div>
																			</div></td>
																		<td scope="row"><div class="input-group">
																				<input type="text" class="form-control"
																					value="${serviceApplicationBean.oneServiceFee}" id="oneServiceFee">
																				<div class="input-group-addon">บาท</div>
																			</div></td>
																	</tr>
																</tbody>
