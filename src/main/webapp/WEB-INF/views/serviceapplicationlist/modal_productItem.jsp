		...
		<div class="modal-content">
			...
			<div class="modal-body"
				...
				<div class="row">
					...
					<i class="fa fa-exclamation-triangle" style="color: orange;"></i>&nbsp;<b style="color: orange;">ระบุ Serial Number แล้วกด Enter / ใช้เครื่องสแกนบาร์โค้ด</b>
					</label>
						<input type="text" name="barCodeScan" id="barCodeScan" class="form-control" value=""
							placeholder="ระบุ Serial Number แล้วกด Enter / ใช้เครื่องสแกนบาร์โค้ด">
					</div>
				</div>
			</div>
			<div class="modal-body">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">
					<i class="zmdi zmdi-search"></i>&nbsp;เลือกบัญชีผู้ใช้อินเตอร์เน็ต
				</h4>
			</div>
