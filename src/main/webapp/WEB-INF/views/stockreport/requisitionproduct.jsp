...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<embed class="card" src="${pageContext.request.contextPath}/stockreport/requisitionproduct/exportPdf/reportrange/'+reportrange+'/equipmentProductType/'+equipmentProductType+'/equipmentStock/'+equipmentStock+'/split/'+split+'/sort/'+sort+'" width="100%" height="500" type="application/pdf">';
