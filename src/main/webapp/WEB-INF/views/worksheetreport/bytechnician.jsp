...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<embed class="card" src="${pageContext.request.contextPath}/worksheetreport/bytechnician/exportPdf/reportrange/'+reportrange+'/technician/'+technician+'/worksheetStatus/'+worksheetStatus+'/zone/'+zone+'" width="100%" height="500" type="application/pdf">';
