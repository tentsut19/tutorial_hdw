...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<embed class="card" src="${pageContext.request.contextPath}/worksheetreport/bydailywork/exportPdf/reportrange/'+reportrange+'/technician/'+technician+'/zone/'+zone+'" width="100%" height="500" type="application/pdf">';
