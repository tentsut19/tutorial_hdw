...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<embed class="card" src="${pageContext.request.contextPath}/financialreport/byinvoicetype/exportPdf/reportrange/'+reportrange+'/invoiceType/'+invoiceType+'/split/'+split+'/invoiceStatus/'+invoiceStatus+'" width="100%" height="500" type="application/pdf">';
