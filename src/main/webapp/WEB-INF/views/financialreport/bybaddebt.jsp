...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<embed class="card" src="${pageContext.request.contextPath}/financialreport/bybaddebt/exportPdf/reportrange/'+reportrange+'/split/'+split+'" width="100%" height="500" type="application/pdf">';
