		...
		$.ajax({
			...
			success : function(data) {
				if(data["error"] == false){ 
					...
					var equipmentProductItemBeans = data.result.equipmentProductItemBeans;
					var internetProductBeanItems = data.result.internetProductBeanItems;
...
// 					</div></td>';
					...
					var columnReturnDevice  = '<td align="center" style="vertical-align: middle;">\
							<label class="custom-control custom-checkbox">\
								<input type="checkbox" class="custom-control-input check-return-device" disabled="disabled" > <span\
								class="custom-control-indicator"></span> <span\
								class="custom-control-description"></span>\
							</label>\
							<input type="checkbox" class="custom-control-input check-box-free" >\
...
// 					rows = rows + totalPrice;
					rows = rows + columnReturnDevice + columnAction + endRow;
