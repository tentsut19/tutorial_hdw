...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<embed class="card" src="${pageContext.request.contextPath}/customerreport/byserviceapptype/exportPdf/reportrange/'+reportrange+'/serviceApplicationType/'+serviceApplicationType+'" width="100%" height="500" type="application/pdf">';
