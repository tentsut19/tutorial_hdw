...
$("#exportPdf").click(function () {
	...
	var embedPdf = '<embed class="card" src="${pageContext.request.contextPath}/customerreport/byworksheetmove/exportPdf/reportrange/'+reportrange+'/sortingStyle/'+sortingStyle+'" width="100%" height="500" type="application/pdf">';
